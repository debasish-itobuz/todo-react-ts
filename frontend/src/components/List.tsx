...
//   _id: string;
//   title: string;
//   status: Status; // Added completed property
// };
...
//   const handleUpdate = async (id: string, title: string, status: boolean) => {
//     try {
//       const token = localStorage.getItem("token");
...
//         {
//           title: title,
//           status: status === true ? Status.completed : Status.todo,
//         },
//         {
//           headers: {
//             Authorization: token,
...
//       todo._id === id ? { ...todo, status: isChecked === true ? Status.completed : Status.todo } : todo
//     );
...
//     if (updatedTodo) {
//       handleUpdate(id, updatedTodo.title, isChecked);
//     }
// };
...
//                     onClick={() => handleUpdate(item._id, editTitle, isChecked)}
